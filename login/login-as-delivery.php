...
<html>
  ...
  <div class="panel-heading">
    <h3 class="panel-title panel_title">Register as Delivery</h3>
  </div>
  <div class="panel-body">
		<form method="post" action="../connection/delivery_script_login.php">
    ...
    <div class="panel-footer panel-footer-modified">
        Don't have an account?Click <a href="../register/register-as-delivery.php">here</a> to register.
    </div>
		<?php
